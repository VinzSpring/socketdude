<template>
    <div class="container">
        <div class="tabBar">
            <div class="tab">jhuihzgzg</div>
            <div class="tab">fefwefe</div>
            <div class="tab">fefwefe</div>
            <div class="tab">fefwefe</div>
            <div class="tab">fefwefe</div>
            <div class="tab">fefwefe</div>

            <svg class="addButton" width="30" height="30" viewBox="0 0 30 30" fill="none"
        ...
        <AutomatedResponseView>
        </AutomatedResponseView>
    </div>
</template>

<script>
    import AutomatedResponseView from "./AutomatedResponseView";

    export default {
        name: "TabView",
        components: {AutomatedResponseView}
    }
</script>
